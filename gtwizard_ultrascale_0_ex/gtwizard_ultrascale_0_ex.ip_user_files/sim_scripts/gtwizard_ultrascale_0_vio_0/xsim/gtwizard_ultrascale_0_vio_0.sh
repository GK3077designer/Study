...
#
# Script generated by Vivado on Mon Aug 03 05:08:22 +0530 2026
...
#
# Usage        : gtwizard_ultrascale_0_vio_0.sh
#                gtwizard_ultrascale_0_vio_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gtwizard_ultrascale_0_vio_0.sh [-rerun]
#                gtwizard_ultrascale_0_vio_0.sh [-reset_run]
#                gtwizard_ultrascale_0_vio_0.sh [-clean]
#                gtwizard_ultrascale_0_vio_0.sh [-reset_log]
#                gtwizard_ultrascale_0_vio_0.sh [-help]
#
...
export RDI_DATADIR="D:/2025.2/Vivado/data"
...
# script info
echo -e "gtwizard_ultrascale_0_vio_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gtwizard_ultrascale_0_vio_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gtwizard_ultrascale_0_vio_0 xil_defaultlib.gtwizard_ultrascale_0_vio_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gtwizard_ultrascale_0_vio_0.wdb xsim.dir libdpi.so)
...
Usage: gtwizard_ultrascale_0_vio_0.sh [-step]\n\
Usage: gtwizard_ultrascale_0_vio_0.sh [-lib_map_path]\n\
Usage: gtwizard_ultrascale_0_vio_0.sh [-rerun]\n\
Usage: gtwizard_ultrascale_0_vio_0.sh [-reset_run]\n\
Usage: gtwizard_ultrascale_0_vio_0.sh [-clean]\n\
Usage: gtwizard_ultrascale_0_vio_0.sh [-reset_log]\n\
Usage: gtwizard_ultrascale_0_vio_0.sh [-keep_index]\n\
