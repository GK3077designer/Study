...
# XDC: new/gt_example.xdc

# Block Designs: bd/design_1/design_1.bd
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1 || ORIG_REF_NAME==design_1} -quiet] -quiet

# IP: bd/design_1/ip/design_1_gtwizard_ultrascale_0_0/design_1_gtwizard_ultrascale_0_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1_gtwizard_ultrascale_0_0 || ORIG_REF_NAME==design_1_gtwizard_ultrascale_0_0} -quiet] -quiet
